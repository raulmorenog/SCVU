...
FT_lat.nofact{2,1} = FT_lat.nofact{2,1}*(2*p.Us/p.c);
FT_lat.nofact{3,1} = FT_lat.nofact{3,1}*(2*p.Us/p.c);
FT_lat.nofact{2,2} = FT_lat.nofact{2,2}*(2*p.Us/p.c);
FT_lat.nofact{3,2} = FT_lat.nofact{3,2}*(2*p.Us/p.c);
...
FT_lat.fact = struct('deltaA_v',zpk(FT_lat.nofact{1,1}),...
                     ...
                     'deltaR_v',zpk(FT_lat.nofact{1,2}),...
...
[wn, amort, Poles] = damp(FT_lat.fact.deltaA_v);
